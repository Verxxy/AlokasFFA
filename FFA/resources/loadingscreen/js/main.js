(function($) {
    ...
    $(window).load(function() {
        ...
        setTimeout(function() {
            $(".introduction").delay(1700).css({
                display: "none"
            }).fadeIn(900);
            $("#particles-holder").delay(1500).css({
                display: "none"
            }).fadeIn(800);
            $("#customizer, .corner").delay(1500).css({
                display: "none"
            }).fadeIn(800)
        }, 0);
        setTimeout(function() {
    ...
    $("#fire-home").on("click", function(e) {
        ...
        $(".current").removeClass("current").fadeOut(1200, function() {
            $("#home").fadeIn(1800).addClass("current")
        })
    });
    $("#fire-services").on("click", function(e) {
        e.preventDefault();
        $(".current").removeClass("current").fadeOut(1200, function() {
            $("#services").fadeIn(1800).addClass("current")
        })
    });
    $("#fire-contact").on("click", function(e) {
        e.preventDefault();
        $(".current").removeClass("current").fadeOut(1200, function() {
            $("#contact").fadeIn(1800).addClass("current")
        })
    });
